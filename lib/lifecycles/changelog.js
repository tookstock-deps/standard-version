...
function outputChangelog (args, newVersion) {
  return new Promise((resolve, reject) => {
    ...
    const { releaseCount = 1 } = args // 0 to write entire history
    const opts = {
    ...
    // console.warn('conventionalChangelog options: ', opts)
    const changelogStream = conventionalChangelog(opts, context, { merges: true, path: args.path })
